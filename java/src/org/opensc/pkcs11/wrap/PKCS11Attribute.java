/***********************************************************
 * $Id: PKCS11Attribute.java 44 2007-01-28 20:29:17Z wolfgang.glas $
 * 
...
public class PKCS11Attribute
{
    ...
    static {
        ...
        if (System.getProperty("os.name").contains("Windows")) {
            ...
            wordsize = System.getProperty("os.arch").endsWith("64") ? 64 : 32;
        }
    }
     ...
     * 
     * @param kind The kind of the attribute, which is one of the CKA_* contants.
    ...
    public PKCS11Attribute(int kind, int dword)
    {
        ...
        else
        {
        	int i = this.data.length - 4;
       		this.data[i++] = (byte)(dword >> 24);
       		this.data[i++] = (byte)(dword >> 16);
       		this.data[i++] = (byte)(dword >> 8);
       		this.data[i++] = (byte)(dword);
        }
    }
