/***********************************************************
 * $Id: PKCS11Session.java 80 2007-03-21 21:13:28Z andreas.schwier $
 * 
...
public class PKCS11Session extends DestroyableHolder
{
	...
	private static native long generateKeyNative(long pvh, long shandle, long hsession, int algo, Object param, PKCS11Attribute[] keyAttrs) throws PKCS11Exception;
	private static native long[] generateKeyPairNative(long pvh, long shandle, long hsession, int algo, Object param, PKCS11Attribute[] pubAttrs, PKCS11Attribute[] privAttrs) throws PKCS11Exception;
	private static native byte[] wrapKeyNative(long pvh, long shandle, long hsession, int algo, Object param, long hwrapkey, long hkey) throws PKCS11Exception;
	private static native long unwrapKeyNative(long pvh, long shandle, long hsession, int algo, Object param, long hwrapkey, byte[] wrappedKey, PKCS11Attribute[] keyAttrs) throws PKCS11Exception;
	private static native long deriveKeyNative(long pvh, long shandle, long hsession, int algo, Object param, long hbasekey, PKCS11Attribute[] keyAttrs) throws PKCS11Exception;
	...
	private native void initPINNative(long _pvh, long _shandle, long _handle, byte[] PIN) throws PKCS11Exception;

	/**
	 * Initialize the user PIN
	 * 
	 * @param PIN the user PIN to initialize the token with
	 * @throws PKCS11Exception Upon errors during PIN initialization
	 */
	public void initPIN(char[] PIN) throws PKCS11Exception {
		initPINNative(this.pvh, this.shandle, this.handle, Util.translatePin(PIN));
	}

	private native void setPINNative(long _pvh, long _shandle, long _handle, byte[] oldPIN, byte[] newPIN) throws PKCS11Exception;

	/**
	 * Change the user PIN
	 * 
	 * @param oldPIN the old PIN value
	 * @param newPIN the new PIN value
	 * @throws PKCS11Exception
	 */
	public void setPIN(char[] oldPIN, char[] newPIN) throws PKCS11Exception {
		setPINNative(this.pvh, this.shandle, this.handle, Util.translatePin(oldPIN), Util.translatePin(newPIN));
	}
	 ...
	 * @throws PKCS11Exception
	 */
	public void signInit(long key, int mech, byte[] param) throws PKCS11Exception {
		signInitNative(this.pvh, this.shandle, this.handle, key, mech, param);
	}
	 ...
	 * @throws PKCS11Exception
	 */
	public void verifyInit(long key, int mech, byte[] param) throws PKCS11Exception {
		verifyInitNative(this.pvh, this.shandle, this.handle, key, mech, param);
	}
	 ...
	 * @throws PKCS11Exception
	 */
	public void encryptInit(long key, int mech, byte[] param) throws PKCS11Exception {
		encryptInitNative(this.pvh, this.shandle, this.handle, key, mech, param);
	}
	 ...
	 * @throws PKCS11Exception
	 */
	public void decryptInit(long key, int mech, byte[] param) throws PKCS11Exception {
		decryptInitNative(this.pvh, this.shandle, this.handle, key, mech, param);
	}
	 ...
	 * 
	 * @param mech		the generation algorithm
	 * @param param		the mechanism parameter
	 * @param keyAttrs	the attributes for the secret key
	 * @return			the handle for the newly created key
	 * @throws PKCS11Exception
	 */
	public long generateKey(int algorithm, Object param, PKCS11Attribute[] keyAttrs) throws PKCS11Exception {
		return generateKeyNative(this.pvh, this.shandle, this.handle, algorithm, param, keyAttrs);
	}
	 ...
	 * @param mech		the generation algorithm
	 * @param param		the mechanism parameter
	 * @param pubAttrs	the attributes for the public key
	 * @param priAttrs	the attributes for the private key
	 * @return			an array of two key handles, the public key at index 0, the private key at index 1
	 * @throws PKCS11Exception
	 */
	public long[] generateKeyPair(int algorithm, Object param, PKCS11Attribute[] pubAttrs, PKCS11Attribute[] priAttrs) throws PKCS11Exception {
		return generateKeyPairNative(this.pvh, this.shandle, this.handle, algorithm, param, pubAttrs, priAttrs);
	}

	/**
	 * Wrap a key using a wrapping key
	 * 
	 * @param algorithm	the wrapping algorithm
	 * @param param		the algorithm parameter
	 * @param hwrapkey	the wrapping key
	 * @param hkey		the key to wrap
	 * @return			the wrapped key
	 * @throws PKCS11Exception
	 */
	public byte[] wrapKey(int algorithm, Object param, long hwrapkey, long hkey) throws PKCS11Exception {
		return wrapKeyNative(this.pvh, this.shandle, this.handle, algorithm, param, hwrapkey, hkey);
	}
	 ...
	 * @throws PKCS11Exception
	 */
	public byte[] wrapKey(int algorithm, Object param, PKCS11Object hwrapkey, PKCS11Object hkey) throws PKCS11Exception {
		return wrapKeyNative(this.pvh, this.shandle, this.handle, algorithm, param, hwrapkey.getHandle(), hkey.getHandle());
	}
	 ...
	 * @param keyAttrs	the key attributes for the unwrapped key
	 * @return			the handle for the unwrapped key
	 * @throws PKCS11Exception
	 */
	public long unwrapKey(int algorithm, Object param, long hwrapkey, byte[] wrappedKey, PKCS11Attribute[] keyAttrs) throws PKCS11Exception {
		return unwrapKeyNative(this.pvh, this.shandle, this.handle, algorithm, param, hwrapkey, wrappedKey, keyAttrs);
	}
	 ...
	 * @throws PKCS11Exception
	 */
	public long unwrapKey(int algorithm, Object param, PKCS11Object hwrapkey, byte[] wrappedKey, PKCS11Attribute[] keyAttrs) throws PKCS11Exception {
		return unwrapKeyNative(this.pvh, this.shandle, this.handle, algorithm, param, hwrapkey.getHandle(), wrappedKey, keyAttrs);
	}
	 ...
	 * @param param		the derivation parameter
	 * @param hbasekey	the key to use for derivation
	 * @param keyAttrs	the attributes for the derived key
	 * @return			the handle for the derived key
	 * @throws PKCS11Exception
	 */
	public long deriveKey(int algorithm, Object param, long hbasekey, PKCS11Attribute[] keyAttrs) throws PKCS11Exception {
		return deriveKeyNative(this.pvh, this.shandle, this.handle, algorithm, param, hbasekey, keyAttrs);
	}
	 ...
	 * @throws PKCS11Exception
	 */
	public long deriveKey(int algorithm, Object param, PKCS11Object hbasekey, PKCS11Attribute[] keyAttrs) throws PKCS11Exception {
		return deriveKeyNative(this.pvh, this.shandle, this.handle, algorithm, param, hbasekey.getHandle(), keyAttrs);
	}
}
